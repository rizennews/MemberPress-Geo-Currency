...
define( 'MPGC_PLUGIN_VERSION', '1.0.1' );
...
add_action( 'plugins_loaded', __NAMESPACE__ . '\mpgc_load_textdomain' ); // Correctly hook using namespace

// Update Checker (using YahnisElsts/plugin-update-checker)
require_once MPGC_PLUGIN_DIR . 'vendor/yahnis-elsts/plugin-update-checker/plugin-update-checker.php';
...
function mpgc_init() {
    ...
    if ( is_plugin_active( 'memberpress/memberpress.php' ) ) {
        ...
        add_action( 'admin_notices', __NAMESPACE__ . '\mpgc_memberpress_not_active_notice' );
    }
}
add_action( 'plugins_loaded', __NAMESPACE__ . '\mpgc_init' );
...
add_action( 'admin_enqueue_scripts', __NAMESPACE__ . '\mpgc_enqueue_admin_scripts' );